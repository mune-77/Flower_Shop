        ...
        <div className="row">
          <div className="col-lg-8 col-12 mb-5">
            ...
            <input
              ...
              className="form-control rounded-0 p-2 px-3"
            />
            ...
            <div className="row">
              <div className="col-lg-6 col-12">
                <label htmlFor="" className="mt-3 required d-block">
                  First name
                </label>
            ...
            <label htmlFor="" className="mt-4  required d-block">
              Contact
            </label>
            <input type="text" className="mt-2 form-control rounded-0" />
            <label htmlFor="" className="mt-4 required d-block">
            ...
            <input
              type="text"
              className="mt-2 form-control rounded-0 p-2 px-3"
            ...
            />
            <input type="checkbox" className="mt-4 mb-5" />{" "}
            <span className="ms-3">Save this infomation for next time</span>
          </div>
          <div className="col-lg-4 col-12 py-3 ">
            <Card
              className="mt-5 rounded-0 border-0 p-3"
            ...
            >
              <Card.Body>
                <div className="d-flex gap-2">
                  ...
                  <p
                    className="fs-5 mb-0"
                    style={{ color: "#c2c2c4", marginTop: "-3px" }}
                  >
                ...
                <div className="input-group">
                  ...
                  <button
                    className="bg-dark text-white btn rounded-0"
                ...
                <p className="mt-3 text-muted">
                  <span className="fw-bold">Coupon Code:</span> CODE26
                </p>
                ...
                <div className="d-flex justify-content-between fw-bold mt-3">
                  <p>Total</p>
                  <p style={{ color: "#f45d96" }}>{finalTotal.toFixed(2)} $</p>
                </div>
              </Card.Body>
            </Card>
          </div>
